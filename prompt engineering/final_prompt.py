...
# Example output
Output ONLY a JSON object with this exact key: "new_edges". 
source_id and target_id must be node IDs exactly as written in <graph_content> (e.g. "bug_302", "commit_901")
{
  "new_edges": [
    {
      ...
      "confidence": 0.91,
      "system": "LLM",
      "explanation": "The commit message explicitly addresses the bug description. Temporal proximity and semantic match support this link."
    }
  ]
}
...
# Graph edge labels
| Source type | Target type | Allowed labels                                                                                                                        |
|-------------|-------------|---------------------------------------------------------------------------------------------------------------------------------------|
